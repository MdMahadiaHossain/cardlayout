...
/** @constructor */
function $c_LClientEntry$() {
  $c_O.call(this)
}
$c_LClientEntry$.prototype = new $h_O();
$c_LClientEntry$.prototype.constructor = $c_LClientEntry$;
/** @constructor */
function $h_LClientEntry$() {
  /*<skip>*/
}
$h_LClientEntry$.prototype = $c_LClientEntry$.prototype;
$c_LClientEntry$.prototype.init___ = (function() {
  return this
});
$c_LClientEntry$.prototype.main__AT__V = (function(args) {
  (0, $m_Lorg_querki_jquery_package$().$$$1)($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument()).ready((function() {
    return $m_LClientEntry$().ClientEntry$$$anonfun$main$1__O()
  }))
});
$c_LClientEntry$.prototype.ClientEntry$$$anonfun$main$1__O = (function() {
  $m_LToggleSet$().toggleBurger__V();
  $m_LToggleSet$().dropdown__V()
});
var $d_LClientEntry$ = new $TypeData().initClass({
  LClientEntry$: 0
}, false, "ClientEntry$", {
  LClientEntry$: 1,
  O: 1
});
$c_LClientEntry$.prototype.$classData = $d_LClientEntry$;
var $n_LClientEntry$ = (void 0);
function $m_LClientEntry$() {
  if ((!$n_LClientEntry$)) {
    $n_LClientEntry$ = new $c_LClientEntry$().init___()
  };
  return $n_LClientEntry$
}
/** @constructor */
function $c_LToggleSet$() {
  $c_O.call(this)
}
$c_LToggleSet$.prototype = new $h_O();
$c_LToggleSet$.prototype.constructor = $c_LToggleSet$;
/** @constructor */
function $h_LToggleSet$() {
  /*<skip>*/
}
$h_LToggleSet$.prototype = $c_LToggleSet$.prototype;
$c_LToggleSet$.prototype.init___ = (function() {
  return this
});
$c_LToggleSet$.prototype.dropdown__V = (function() {
  (0, $m_Lorg_querki_jquery_package$().$$$1)(".kpv-dropdown").click($m_Lorg_querki_jquery_package$().ft02EventHandler__F1__sjs_js_$bar(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(element$2) {
      var qual$2 = (0, $m_Lorg_querki_jquery_package$().$$$1)(element$2.childNodes.item(4));
      return qual$2.fadeToggle(200, "swing")
    })
  })(this))))
});
$c_LToggleSet$.prototype.toggleBurger__V = (function() {
  (0, $m_Lorg_querki_jquery_package$().$$$1)(".kpv-humburger").click($m_Lorg_querki_jquery_package$().f02EventHandler__F0__sjs_js_$bar(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this) {
    return (function() {
      var qual$1 = (0, $m_Lorg_querki_jquery_package$().$$$1)(".kpv-sidemenubar");
      return qual$1.fadeToggle(170, "swing")
    })
  })(this))))
});
var $d_LToggleSet$ = new $TypeData().initClass({
  LToggleSet$: 0
}, false, "ToggleSet$", {
  LToggleSet$: 1,
  O: 1
});
$c_LToggleSet$.prototype.$classData = $d_LToggleSet$;
var $n_LToggleSet$ = (void 0);
function $m_LToggleSet$() {
  if ((!$n_LToggleSet$)) {
    $n_LToggleSet$ = new $c_LToggleSet$().init___()
  };
  return $n_LToggleSet$
}
/** @constructor */
...
$c_Lorg_querki_jquery_package$.prototype.ft02EventHandler__F1__sjs_js_$bar = (function(func) {
  var a = (function(f) {
    return (function() {
...
$m_LClientEntry$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
